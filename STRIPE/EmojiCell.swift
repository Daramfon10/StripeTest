...
class PlusMinusButton: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let circleColor: UIColor = style == .plus ? #colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1) : backgroundColor
        circleColor.setFill()
        circle.fill()
        ...
        let lineColor: UIColor = style == .minus ? #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1): backgroundColor
        lineColor.setFill()
        horizontalLine.fill()
        if style == .plus {
            verticalLine.fill()
