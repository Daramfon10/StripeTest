...
class MyAPIClient: NSObject, STPCustomerEphemeralKeyProvider {
    ...
    func createPaymentIntent(products: [Product], shippingMethod: PKShippingMethod?, country: String? = nil, completion: @escaping ((Swift.Result<String, Error>) -> Void)) {
...
//        //urlComponents.queryItems = [URLQueryItem(name: "customer_id", value: "cus_G1ZYMAS1PGP2BE")]
...
//        })
    ...
    "api_version": apiVersion, "customer_id": "cus_G1ZYMAS1PGP2BE"
      ])
